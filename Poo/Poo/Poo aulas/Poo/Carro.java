...
public class Carro {
    ...
    public void start() {
        ...
        if (!isRunning) {
            isRunning = true;
            System.out.println("O carro está ligado, VRUMM!!");
        }
    }
    ...
    public void stop() {
        ...
        if (isRunning) {
            isRunning = false;
            System.out.println("O carro foi delisgado!");
        }
    }
    ...
    public void drive(int distance) {
        if (isRunning) {
            ...
            System.out.println("O carro está "+distance);
            System.out.println("Km é: "+this.velocidade);
        } else {
            System.out.println("O carro está desligado, precisa ligar o carro primeiro, para acelerar!");
        }
    }
